...
namespace GWF_WCF_WebRole.Services.Interfaces
{
    ...
    interface IMessageService
    {
        ...
        [OperationContract]
        CMessages GetMessages(string feed_id);
        ...
        [OperationContract]
        GWFInfoCode SendIMMessage(string from_uid, string to_uid, string content);
        ...
        [WebInvoke(UriTemplate = "/users/{to_uid}?_action=AddFriendRequest&_from_uid={from_uid}",
            ...
            ResponseFormat = WebMessageFormat.Xml)]
        [OperationContract]
        GWFInfoCode AddFriendRequest(string from_uid, string to_uid);
        ...
        [WebInvoke(UriTemplate = "/users/{to_uid}?_action=AnswerFriendRequest&_from_uid={from_uid}",
            ...
            ResponseFormat = WebMessageFormat.Xml)]
        [OperationContract]
        GWFInfoCode AnswerFriendRequest(string from_uid, string to_uid);
        ...
        [WebInvoke(UriTemplate = "/locations/{uid}?_action=SetLatestLocation&_lat={latitude}&_long={longitude}",
            ...
            ResponseFormat = WebMessageFormat.Xml)]
        [OperationContract]
        GWFInfoCode SetLatestLocation(string uid, double latitude, double longitude);
    }
}
